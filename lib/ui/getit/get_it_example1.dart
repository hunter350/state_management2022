...
import 'get_it_example2.dart';



class GetItExample1 extends StatefulWidget {
  const GetItExample1({Key? key}) : super(key: key);

  @override
  _GetItExampleState createState() => _GetItExampleState();
}

class _GetItExampleState extends State<GetItExample1> {
  _GetItExampleState() {
